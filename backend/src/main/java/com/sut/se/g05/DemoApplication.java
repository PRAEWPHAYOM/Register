...
//			linkRepository.save(l2);
			...
			Stream.of("อนุพงษ์","แพรวโพยม","สิริลักษณ์", "เบญจมาศ","ฐิติมากานต์").forEach(senders -> {
				...
				if(senders == "อนุพงษ์") {
					...
					s.setAddress("sut");
					Province provincesen = provinceRepository.findByprovince("นครราชสีมา");
					...
					s.setAddress("moon");
					Province provincesen = provinceRepository.findByprovince("พิษณุโลก");
					s.setProvincesen(provincesen);
					s.setPostcode("65180");
					s.setPhone("0956399315");
					s.setEmail("ice2");
					...
					s.setAddress("ii");
					Province provincesen = provinceRepository.findByprovince("กรุงเทพมหานคร");
					s.setProvincesen(provincesen);
					s.setPostcode("65180");
					s.setPhone("0956399315");
					s.setEmail("ice3");
					...
					s.setLastname("มัจฉา");
					s.setAddress("ocean");
					Province provincesen = provinceRepository.findByprovince("บุรีรัมย์");
					s.setProvincesen(provincesen);
					s.setPostcode("65180");
					s.setPhone("0956399315");
					s.setEmail("ice4");
